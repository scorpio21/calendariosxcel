...
Public Sub Calendario2025_Cadiz_Imagen()
    ...
    ' === FESTIVOS 2025 (C diz/Andaluc a) y nombres ===
    ...
    festivosNombres = Array( _
        "A o Nuevo", "Epifan a del Se or", "D a de Andaluc a", "Lunes de Carnaval", _
        "Jueves Santo", "Viernes Santo", "Fiesta del Trabajo", "Asunci n de la Virgen", _
        "Virgen del Rosario", "D a siguiente al d a de la Hispanidad", "Todos los Santos", _
        "Constituci n Espa ola", "Inmaculada Concepci n", "Navidad")
